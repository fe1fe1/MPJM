...
escena_gameOver::escena_gameOver() {
	...
	gameOverText.setPosition(sf::Vector2f((640-gameOverText.getGlobalBounds().width)/2.0,-35));
	...
	letrasNombreText.setColor(sf::Color::White);
	letrasNombreText.setPosition(sf::Vector2f((475-letrasNombreText.getGlobalBounds().width)/2.0,100));
	...
	presionaEscapeText.setColor(sf::Color::White);
	...
	highscoreText.setPosition(sf::Vector2f((230-highscoreText.getGlobalBounds().width)/2.0,230));
